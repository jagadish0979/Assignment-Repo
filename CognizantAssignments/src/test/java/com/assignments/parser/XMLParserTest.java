...
public class XMLParserTest extends CognizantAssignmentsApplicationTests {

	@Autowired
	private XMLParser xmlParser;

	@Test
	public void parseFile() throws XMLException {
		...
		assertThat(xmlParser.parseFile(fileContent));
	}
}
